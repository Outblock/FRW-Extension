  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography
          sx={{ fontSize: '14px', color: '#FFFFFF', marginTop: '4px' }}
        >
          <img className={classes.IconCheck} src={IconCheck} /> Delegate dApp
          account to your Flow Wallet
        </Typography>
        <Typography
          sx={{ fontSize: '14px', color: '#FFFFFF', marginTop: '8px' }}
        >
          <img className={classes.IconCheck} src={IconCheck} /> Flow Wallet will
