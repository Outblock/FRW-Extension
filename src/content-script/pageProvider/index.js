...
const switchChainNotice = (chain) => {
    ...
    const rawContent = `<img style="width: 20px; margin-right: 8px;" src="${img$4}"/>Switched to <span class="rabby-strong" style="margin: 0 8px;">${chain === null || chain === void 0 ? void 0 : chain.name}</span> for the current Dapp`;
...
const switchWalletNotice = (type) => {
    ...
    instance = notice({
      ...
      <img style="width: 28px;" src="${type === "rabby" ? img$4 : img}"/>
      <div>
