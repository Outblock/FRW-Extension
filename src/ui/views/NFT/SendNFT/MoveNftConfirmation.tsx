...
const MoveNftConfirmation = (props: SendNFTConfirmationProps) => {
  ...
  const moveNFTToFlow = async () => {
    ...
    const filteredCollections = returnFilteredCollections(
      contractList,
      props.data.nft
    );
    ...
    const getMedia = () => {
      return (
        <>
          ...
          >
            <source
              src={props.data.media?.videoURL || undefined}
              type="video/mp4"
            />
          </video>
        </>
      ...
      >
        ...
        >
          {childWallet && (
            <FRWChildProfile
              contact={childWallet}
              address={props.data.userContact.address}
            />
          )}
          ...
          <Stack direction="column" spacing={1} sx={{ ml: '14px' }}>
            ...
            >
              <CardMedia
                ...
                image={
                  props.data.contract &&
                  props.data.contract.collectionSquareImage
                }
              />
              <Typography
              ...
              >
                {props.data.contract &&
                  props.data.contract.collectionContractName}
              </Typography>
              <span>
