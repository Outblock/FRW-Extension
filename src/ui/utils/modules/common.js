...
export const ifNotNull = (value, func) =>
  notNull(value) ? (notNull(func) && assertFunction(func) ? func(value) : value) : undefined;
export const ifNotEmpty = (value, func) =>
  notEmpty(value) ? (notNull(func) && assertFunction(func) ? func(value) : value) : undefined;
