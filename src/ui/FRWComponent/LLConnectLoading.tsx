...
export const LLConnectLoading = ({logo}) => { 
  ...
  const colorArray = ['rgba(94,94,94,0.3)', 'rgba(94,94,94,0.4)','rgba(94,94,94,0.5)','rgba(94,94,94,0.6)','rgba(94,94,94,0.7)','rgba(94,94,94,0.8)',
    'rgba(94,94,94,0.9)','rgba(94,94,94,1)','rgba(94,94,94,1)','rgba(94,94,94,1)','rgba(94,94,94,1)','rgba(94,94,94,1)','rgba(94,94,94,1)',
    'rgba(94,94,94,1)','rgba(94,94,94,1)',];
  ...
  return (
    ...
    >
      <Box sx={{display: 'flex', justifyContent: 'space-between',alignItems:'center', py: '16px', gap: '12px'}}>
        ...
        <Avatar src="/images/icon-64.png"  style={{ borderRadius: 12 }} sx={{ height: '64px', width: '64px'}} />
      </Box>
