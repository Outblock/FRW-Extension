    ...
    <StyledEngineProvider injectFirst>
      ...
      >
        ...
        >
          ...
          >
            <FormControl sx={{ flex: '1', display: 'flex' }}>
              <Input
                ...
                inputProps={{
                  sx: { fontSize: '24px', backgroundColor: '#1a1a1a' },
                }}
                endAdornment={
                  <InputAdornment position="end">
                    <Stack direction="row" spacing={1}>
                      <Typography color="text.primary" variant="caption">
                        $
                        {parseFloat(
                          (coinInfo.price * amount).toFixed(2)
          ...
          <Box
            sx={{ width: '100%', backgroundColor: '#333333', height: '1px' }}
          ></Box>
          <Box
            sx={{
              display: 'flex',
          ...
          >
            ...
            <Typography sx={{ color: '#5E5E5E' }} variant="caption">
              Staked FLOW
            </Typography>
          </Box>
        </Box>
